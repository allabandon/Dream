...
IFS="@"
FRUITSHARECODES_ARR=($FRUITSHARECODES)//*东东农场*//
PETSHARECODES_ARR=($PETSHARECODES)//*东东萌宠*//
PLANT_BEAN_SHARECODES_ARR=($PLANT_BEAN_SHARECODES)//*种豆得豆*//
JXFACTORY_SHARECODES_ARR=($JXFACTORY_SHARECODES)
DDFACTORY_SHARECODES_ARR=($DDFACTORY_SHARECODES)//*东东工厂*//
DREAM_FACTORY_SHARE_CODES_ARR=($DREAM_FACTORY_SHARE_CODES)//*京喜工厂*//
JDZZ_INVITECODES_ARR=($JDZZ_INVITECODES)//*京东赚赚*//
JDJOY_SHARECODES_ARR=($JDJOY_SHARECODES)//*京东JOY*//
